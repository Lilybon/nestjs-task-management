...
describe('UserRepository', () => {
  ...
  describe('signUp', () => {
    ...
    it('throws a conflict exception as username already exists', async () => {
      ...
      try {
        await userRepository.signUp(mockCredentialDto);
      } catch (error) {
        expect(error).toEqual(new ConflictException('Username already exists'));
      }
    });

    it('throws a internal server exception as unhandled error code comes', async () => {
